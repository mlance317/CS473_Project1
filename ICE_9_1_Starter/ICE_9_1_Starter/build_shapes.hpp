...
//Create and return a BasicShape textured triangle given a VAO and three 
// vertices (glm::vec3 values).
...
BasicShape GetTexturedRectangle (VAOStruct vao, glm::vec3 location = glm::vec3(0.0), float width = 1.0, float height = 1.0);
